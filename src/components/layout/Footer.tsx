    ...
    <footer className="py-6 border-t border-slate-100 bg-white">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <div className="flex flex-col items-center gap-1 text-slate-400 text-sm font-bold text-center">
          ...
          <p className="text-xs font-medium">제작 및 문의 : 하주초등학교 교사 이성근 <a href="mailto:dltjdrms320@gmail.com" className="hover:text-indigo-500 transition-colors">dltjdrms320@gmail.com</a></p>
        </div>
