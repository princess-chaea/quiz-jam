...
export async function POST(req: Request) {
    ...
    const formatPrompt = `[
  {
    ...
    const textPrompt = "당신은 대한민국 최고의 문항 출제 전문가입니다. " +
      ...
      "[퀴즈 유형별 규칙]\n" +
      "1. SHORT_ANSWER: 정답은 반드시 단어, 숫자, 또는 매우 짧은 핵심 구절이어야 하며, 다른 답의 여지 없이 아주 명확한 것만 생성하세요.\n" +
      ...
      "4. BLANK: 문맥상 아주 중요한 용어나 수치에 빈칸을 만드세요. 교사가 초성 힌트를 통해 순서를 안내할 수 있으므로, 두 개 이상의 핵심어를 배치할 때 유용하게 활용하세요.\n\n" +
      "[수식 및 JSON 규칙]\n" +
